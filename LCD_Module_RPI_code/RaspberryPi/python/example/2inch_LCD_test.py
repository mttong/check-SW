...
BL = 23  # Backlight for the second LCD screen (use another GPIO pin like GPIO19)
RST = 6
DC = 12
...
try:
    ...
    disp = LCD_2inch.LCD_2inch(spi=SPI.SpiDev(bus, 1),spi_freq=10000000,rst=RST,dc=DC,bl=BL)
    ...
    while True:
        disp.ShowImage(image)  # Show the image continuously
        time.sleep(1)
